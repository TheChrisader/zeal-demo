...
// New components from template.html conversion
...
const Loader = () => {
  return (
    <div className="min-h-screen bg-gray-100">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between">
            ...
            <div className="hidden lg:flex gap-8">
              <div className="h-6 w-20 animate-pulse bg-gray-300 rounded"></div>
              <div className="h-6 w-16 animate-pulse bg-gray-300 rounded"></div>
              <div className="h-6 w-20 animate-pulse bg-gray-300 rounded"></div>
              <div className="h-6 w-20 animate-pulse bg-gray-300 rounded"></div>
            </div>
            <div className="flex gap-3">
              <div className="h-8 w-16 animate-pulse bg-gray-300 rounded"></div>
              <div className="h-8 w-16 animate-pulse bg-emerald-700 rounded"></div>
            </div>
          </div>
        </div>
      </div>
      ...
      {/* Content skeleton */}
      <div className="flex flex-col items-center justify-center px-4 lg:px-[80px] py-12">
        <div className="w-full max-w-4xl">
          {/* Hero section skeleton */}
          <div className="h-32 w-full animate-pulse bg-gray-300 rounded-lg mb-8"></div>
          <div className="h-8 w-64 mx-auto animate-pulse bg-gray-300 rounded mb-4"></div>
          <div className="h-6 w-96 mx-auto animate-pulse bg-gray-300 rounded mb-8"></div>

          {/* Feature cards skeleton */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            {[1, 2, 3].map((i) => (
              <div key={i} className="bg-white rounded-lg p-6 shadow-md">
                <div className="h-12 w-12 animate-pulse bg-gray-300 rounded mb-4"></div>
                <div className="h-6 w-32 animate-pulse bg-gray-300 rounded mb-2"></div>
                <div className="h-4 w-full animate-pulse bg-gray-300 rounded mb-2"></div>
                <div className="h-4 w-3/4 animate-pulse bg-gray-300 rounded"></div>
              </div>
            ))}
          </div>

          {/* Additional content skeleton */}
          <div className="h-20 w-full animate-pulse bg-gray-300 rounded mb-4"></div>
          <div className="h-20 w-full animate-pulse bg-gray-300 rounded"></div>
        </div>
      </div>
    </div>
  );
